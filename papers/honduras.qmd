...
In Bajo Aguán, Honduras, the agroindustrial corporation Dinant expropriates land legally allocated to campesino cooperatives.[^cespad_pronunciamiento][^icij][^cao] In February 2022, freshly-elected President Xiomara Castro announced the Convenio Agrario, a set of land reform policies "seeking to respect cooperatives' property rights" and "investigate assassinations, forced evictions, and human rights violations against campesinos" in "resolving structural conflicts of land tenancy in the Lower Aguán Valley."[^convenio_agrario_2022] Yet four years on, the Convenio's principal beneficiaries in Bajo Aguán have seemingly abstained from asserting their *de jure* claims to land among the most productive in Latin America. What accounts for this aberrant outcome? 

At work in Bajo Aguán is a coercive apparatus operating in three mechanisms. Its core mechanism is physical violence via targeted assassinations. At least 200 cooperative workers and leaders have been killed since 2009, establishing the cost of organized resistance before the Convenio was signed.[^cespad_causas] After smallholder land claims ticked up post-2022 a second mechanism emerged: judicial inversion, in which any smallholder claim under the Convenio framework could be criminally prosecuted (as a delito de usurpación).[^decreto_usurpacion] A third mechanism, enforcement timing, concentrates violence and prosecutions in response to gains in cooperative organizing capacity. The case of Jaime Cabrera, coordinator for Plataforma Agraria, illustrates this adaptive process. Cabrera was charged with illicit association and unlawful seizure in connection with his Convenio facilitation work. State witnesses in the case could not identify him or any co-defendant. Just ten months after the Convenio's signing, Cabrera was imprisoned from November 2022-August 2023.[^criterio_criminalizacion] Common across the three mechanisms is their deliberate targeting of known cooperative leadership– those engaged in documented political and organizing processes like the Convenio. In this way, the coercive apparatus in Bajo Aguán has transformed a potential policy challenge into a targeting list.

Leveraging ACLED[^acled] event data (2018-2025), Hansen Global Forest Change[^hansen_gfc] forest loss area, and independent on-the-ground reporting,[^criterio_promesas][^cespad_fracaso] the Absent Violence method identifies two critical divergence signals in the post-Convenio period. First, observed popular resistance specifically related to land rights (versus e.g., labor conflicts) is practically absent throughout the panel. After more than a decade[^cespad_causas] of audacious mobilization against Dinant, including occupying its illegally-titled land and direct confrontation with private security forces,[^cao] campesino and MUCA-affiliated events approach zero after 2022. The second divergence signal– forest loss rates around contested land– captures the environmental signature of this observable resistance collapse. Industrial-scale forest clearing reversed a multiyear decline beginning in 2023, the first increase since 2017. Only after organized resistance was stifled did Dinant resume developing illegally expropriated land. Once the Convenio Agrario rendered its opponents legible, this took about 10 months.
...
<iframe src="../charts/assets/convenio_map.html" width="100%" height="560px" frameborder="0" style="border:none;"></iframe>
</div>
```
  *Pre-Convenio period is dominated by VAC concentrated in Tocoa; post-Convenio period shows shift toward battles and strategic developments, with VAC declining in absolute terms but persisting. Event counts are roughly equivalent across periods.*
...
[^convenio_agrario_2022]: Gobierno de Honduras. (2022, February 22). *Convenio Agrario, Bajo Aguán*. Tegucigalpa.
